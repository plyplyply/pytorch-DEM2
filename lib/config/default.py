...
_C.MODEL = CN()
_C.MODEL.NAME1 = 'pose_multi_resolution_net_v16'
_C.MODEL.NAME2 = 'pose_multi_resolution_net_v16'
...
_C.LOSS.OFFSETS_LOSS_FACTOR = [0.01, 0.01]
...
_C.DATASET.WITH_CENTER = True
_C.DATASET.RJG_TAG = [5, 6, 11, 12]
_C.DATASET.LJG_WITH_HIER = [7, 8, 9, 10, 13, 14, 15, 16]
_C.DATASET.LJG_CENTER_ONLY = [0, 1, 2, 3, 4]
# train
_C.TRAIN = CN()
...
_C.DEBUG.SAVE_OFFSETS_GT = True
_C.DEBUG.SAVE_OFFSETS_PRED = True
