...
FLIP_CONFIG = {
    ...
    'COCO_TAG_WITH_CENTER': [
        1, 0, 3, 2, 4  #5, 6, 11, 12, 17=>6, 5, 12, 13, 17
    ],#for tag part
    'COCO_EMB': [
        0, 2, 1, 4, 3, 8, 7, 10, 9, 14, 13, 16, 15
    ],#for emb part
    'CROWDPOSE': [
    ...
    'CROWDPOSE_TAG_WITH_CENTER': [
        1, 0, 3, 2, 4  # 0, 1, 6, 7, 14 => 1, 0, 7, 6, 14
    ],
    'CROWDPOSE_EMB': [
        3, 2, 5, 4, 9, 8, 11, 10, 12, 13
    ]
}
    ...
    transforms = T.Compose(
        [
            T.RandomAffineTransform(
                ...
                scale_type,
                max_translate,
                scale_aware_sigma=cfg.DATASET.SCALE_AWARE_SIGMA # False
            ),
